...
//   >
//     <div
//       className={`absolute -top-8 -right-8 w-24 h-24 bg-gradient-to-br ${color} opacity-10 blur-3xl rounded-full`}
//     />
//     <div
//       className={`w-12 h-12 mb-6 flex items-center justify-center rounded-xl bg-gradient-to-br ${color} text-white shadow-lg`}
//     >
//       <Icon size={26} />
//     </div>
...
//         if (mounted) {
//           // Get results and limit to reduce memory
//           const courseData = Array.isArray(courseRes.data) 
//             ? courseRes.data 
//             : courseRes.data.results || [];
//           const topicData = Array.isArray(topicRes.data)
//             ? topicRes.data
//             : topicRes.data.results || [];
...
//             <Link
//               to="/courses"
//               className="px-6 py-3 rounded-full bg-gradient-to-r from-indigo-500 to-purple-600 text-white text-sm font-semibold shadow-md hover:opacity-90 transition"
//             >
//               Explore Courses
//             </Link>
//             <Link
...
//         <div className="absolute inset-0 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 opacity-20 blur-2xl" />
...
//           <Link
//             to="/register"
//             className="inline-block px-8 py-4 rounded-full bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-semibold text-lg shadow-md hover:opacity-90 transition"
//           >
//             Get Started Free
//           </Link>
//         </div>
